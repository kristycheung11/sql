...
SELECT vendor_id,
count(booth_number) AS num_of_booth_assignments
...
SELECT 
c.customer_id, customer_first_name, customer_last_name, total_spending
FROM customer c
...
VALUES('10','Thomass Superfood Store','a Fresh Focused store',
'Thomas','Rosenthal');
